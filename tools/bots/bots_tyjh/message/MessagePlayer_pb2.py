...
_C2SPLAYERGUIDE = _descriptor.Descriptor(
  name='C2SPlayerGuide',
  full_name='Message.C2SPlayerGuide',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='guide', full_name='Message.C2SPlayerGuide.guide', index=0,
...
_S2CPLAYERLOGIN = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='stime', full_name='Message.S2CPlayerLogin.stime', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='guide', full_name='Message.S2CPlayerLogin.guide', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_S2CPLAYERINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='arenapoint', full_name='Message.S2CPlayerInfo.arenapoint', index=23,
...
_S2CPLAYERGETTHING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='arenapoint', full_name='Message.S2CPlayerGetThing.arenapoint', index=8,
      number=9, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='towerpoint', full_name='Message.S2CPlayerGetThing.towerpoint', index=9,
      number=10, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['C2SPlayerGuide'] = _C2SPLAYERGUIDE
...
C2SPlayerGuide = _reflection.GeneratedProtocolMessageType('C2SPlayerGuide', (_message.Message,), dict(
  DESCRIPTOR = _C2SPLAYERGUIDE,
  __module__ = 'MessagePlayer_pb2'
  # @@protoc_insertion_point(class_scope:Message.C2SPlayerGuide)
  ))
_sym_db.RegisterMessage(C2SPlayerGuide)
