...
_S2CTEAMINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='team_id', full_name='S2CTeamInfo.team_id', index=1,
      number=2, type=5, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='formation', full_name='S2CTeamInfo.formation', index=2,
      number=3, type=5, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='apply', full_name='S2CTeamInfo.apply', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='isnew', full_name='S2CTeamInfo.isnew', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='join_pid', full_name='S2CTeamInfo.join_pid', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='quit_pid', full_name='S2CTeamInfo.quit_pid', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='kick_pid', full_name='S2CTeamInfo.kick_pid', index=7,
...
_S2CMEMBERSTATUS = _descriptor.Descriptor(
  name='S2CMemberStatus',
  full_name='S2CMemberStatus',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='pid', full_name='S2CMemberStatus.pid', index=0,
      number=1, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='status', full_name='S2CMemberStatus.status', index=1,
      number=2, type=5, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_C2SPLAYERMATCH = _descriptor.Descriptor(
  name='C2SPlayerMatch',
  full_name='C2SPlayerMatch',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='C2SPlayerMatch.type', index=0,
...
_C2STEAMMATCH = _descriptor.Descriptor(
  name='C2STeamMatch',
  full_name='C2STeamMatch',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='C2STeamMatch.type', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['S2CMemberStatus'] = _S2CMEMBERSTATUS
DESCRIPTOR.message_types_by_name['C2SPlayerMatch'] = _C2SPLAYERMATCH
DESCRIPTOR.message_types_by_name['C2STeamMatch'] = _C2STEAMMATCH
...
S2CMemberStatus = _reflection.GeneratedProtocolMessageType('S2CMemberStatus', (_message.Message,), dict(
  DESCRIPTOR = _S2CMEMBERSTATUS,
  __module__ = 'MessageTeam_pb2'
  # @@protoc_insertion_point(class_scope:S2CMemberStatus)
  ))
_sym_db.RegisterMessage(S2CMemberStatus)

C2SPlayerMatch = _reflection.GeneratedProtocolMessageType('C2SPlayerMatch', (_message.Message,), dict(
  DESCRIPTOR = _C2SPLAYERMATCH,
  __module__ = 'MessageTeam_pb2'
  # @@protoc_insertion_point(class_scope:C2SPlayerMatch)
  ))
_sym_db.RegisterMessage(C2SPlayerMatch)

C2STeamMatch = _reflection.GeneratedProtocolMessageType('C2STeamMatch', (_message.Message,), dict(
  DESCRIPTOR = _C2STEAMMATCH,
  __module__ = 'MessageTeam_pb2'
  # @@protoc_insertion_point(class_scope:C2STeamMatch)
  ))
_sym_db.RegisterMessage(C2STeamMatch)
