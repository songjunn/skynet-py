...
_TASKLIMITTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='TASK_LIMIT_ONCE', index=0, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_LIMIT_EVERYDAY', index=1, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_LIMIT_EVERYWEEK', index=2, number=3,
      options=None,
      type=None),
  ],
  containing_type=None,
